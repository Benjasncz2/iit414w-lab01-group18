...
| Random Forest | `grid, circuit_id, constructor_id` | 2024 Season | **0.7759** | 0.8161 | -0.0402 | Better at identifying nonlinear team strengths on training data. Instead of overfitting, Test F1 is higher because 2024 had fewer unpredictable mechanical DNFs, amplifying the pure causal dominance of grid position. |
